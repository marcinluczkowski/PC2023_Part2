...
namespace PC2023_Part2
{
    public class MakeBrep : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("beams", "bs", "list of BeamClass", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            for (int i = 0; i < bcs.Count; i++) 
            {
                ...
                if (bc.name == "horizontalBeam")
                {
                    ...
                    line1.Transform(t1);
                    bc.brep = Brep.CreateFromCornerPoints(axis.To, axis.From, line1.From, line1.To, 0.0001);
                }
                else if (bc.name == "verticalBeam") 
                {
                    ...
                    line2.Transform(t2);
                    bc.brep = Brep.CreateFromCornerPoints(axis.To, axis.From, line2.From, line2.To, 0.0001);
                }
        ...
        {
            get { return new Guid("F9730964-2D98-471B-861C-203381E5EC68"); }
        }
    }
}